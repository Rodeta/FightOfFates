    ...
    public class LobbyMainPanel : MonoBehaviourPunCallbacks
    {
        ...
        public override void OnJoinedRoom()
        {
            ...
            foreach (Player p in PhotonNetwork.PlayerList)
            {
                ...
                if (p.CustomProperties.TryGetValue(Constance.PLAYER_READY, out isPlayerReady))
                {
            ...
            {
                {Constance.PLAYER_LOADED_LEVEL, false}
        ...
        public override void OnPlayerPropertiesUpdate(Player targetPlayer, Hashtable changedProps)
        {
            ...
            {
                object isPlayerReady;
                if (changedProps.TryGetValue("playerIsReady", out isPlayerReady))
                {
                    entry.GetComponent<PlayerListEntry>().SetPlayerReady((bool) isPlayerReady);
                }
            }
        ...
        public void OnStartGameButtonClicked()
        {
            ...
            {
                object money;
                if(p.CustomProperties.TryGetValue(Constance.MONEY, out money))
                {
        ...
        private void UpdateRoomListView()
        {
            foreach (RoomInfo info in cachedRoomList.Values)
            {
                ...
                entry.transform.localScale = Vector3.one;
                entry.GetComponent<RoomListEntry>().Initialize(info.Name, (byte)info.PlayerCount, 2);
