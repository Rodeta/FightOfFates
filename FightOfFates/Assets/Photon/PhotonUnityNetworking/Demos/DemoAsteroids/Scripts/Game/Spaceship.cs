...
#pragma warning restore 0109
        ...
        public void Start()
        {
            ...
            {
                r.material.color = PlayAttribut.GetColor(photonView.Owner.GetPlayerNumber());
            }
        }
        ...
        {
            yield return new WaitForSeconds(PlayAttribut.PLAYER_RESPAWN_TIME);
        ...
        public void DestroySpaceship()
        {
            ...
            {
                object lives;
                if (PhotonNetwork.LocalPlayer.CustomProperties.TryGetValue(PlayAttribut.PLAYER_LIVES, out lives))
                {
                    PhotonNetwork.LocalPlayer.SetCustomProperties(new Hashtable {{PlayAttribut.PLAYER_LIVES, ((int) lives <= 1) ? 0 : ((int) lives - 1)}});
